...
task Package -depends Build {
  ...
  robocopy $sourceDir $workingDir\Package\Source\Src /MIR /NP /XD bin obj TestResults AppPackages Newtonsoft.Json.sln.ide $packageDirs /XF *.suo *.user | Out-Default
